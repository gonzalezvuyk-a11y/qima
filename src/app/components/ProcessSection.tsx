...
export function ProcessSection() {
  return (
    <section id="process" className="relative bg-[#f3efe8] py-36">
        ...
        <div className="grid grid-cols-4 gap-8">
          {steps.map((step, i) => {
            ...
            return (
              <div
                key={step.number}
                className="relative px-8 py-10 group rounded-2xl border border-[#0a0a0a]/[0.06] bg-white/40 transition-all duration-500 hover:bg-white/80 hover:shadow-[0_8px_40px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:border-[#c8e645]/30"
              >
                ...
                <h3
                  className="text-[#0a0a0a] group-hover:text-[#0a0a0a] transition-colors duration-500 mb-4"
                  style={{ fontFamily: "Inter, sans-serif", fontSize: "1.0625rem", fontWeight: 500, lineHeight: 1.4 }}
                >
                  {step.title}
                </h3>
                <p
                  className="text-[#0a0a0a]/55 group-hover:text-[#0a0a0a]/75 transition-colors duration-500"
                  style={{ fontFamily: "Inter, sans-serif", fontSize: "0.875rem", fontWeight: 300, lineHeight: 1.7 }}
                >
                  {step.text}
                </p>

                {/* Top line accent */}
                <div className="absolute top-0 left-8 right-8 h-[2px] bg-[#c8e645]/0 group-hover:bg-[#c8e645]/60 transition-all duration-500 rounded-full" />
              </div>
            );
          })}
        </div>
